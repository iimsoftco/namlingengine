...
void runNamlinx(const std::string& script, NamlinxContext& ctx, sf::Texture& thanTex) {
    ...
    while (std::getline(in, line)) {
        ...
        if (line.find("==") != std::string::npos && line.find("then") != std::string::npos) {
            ...
            if (lhs == rhs) runNamlinx(assignment, ctx, thanTex);
...
int main() {
    ...
    sf::Texture namTex, thanTex;
    if (!namTex.loadFromFile("assets/namling.png") || !thanTex.loadFromFile("assets/thanling.png")) {
